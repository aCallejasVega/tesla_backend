...
public class EntidadesController {
	...
	public ResponseEntity<?> findEntidadByRecaudacionId(Authentication authentication) throws Exception {
	...
	public ResponseEntity<?> findAllEntidad(Authentication authentication) throws Exception {
