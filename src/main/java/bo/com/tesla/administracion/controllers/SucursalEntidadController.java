...
public class SucursalEntidadController {
	...
	public ResponseEntity<?> addUpdateSucursalEntidad(@Valid @RequestBody SucursalEntidadAdmDto sucursalEntidadAdmDto,
		...
		try {
			...
			sucursalEntidadAdmDto = iSucursalEntidadService.addUpdateSucursalEntidad(sucursalEntidadAdmDto,
					usuario.getUsuarioId());
			response.put("status", true);
			response.put("message", esModificacion ? "Se realizó la actualización del registro correctamente."
	...
	public ResponseEntity<?> setTransaccion(@PathVariable Long sucursalEntidadId, @PathVariable String transaccion,
			Authentication authentication) {
		SegUsuarioEntity usuario = this.segUsuarioService.findByLogin(authentication.getName());
		Map<String, Object> response = new HashMap<>();
		try {
			iSucursalEntidadService.setTransaccionSucursalEntidad(sucursalEntidadId, transaccion,
					usuario.getUsuarioId());
			response.put("status", true);
	...
	public ResponseEntity<?> setTransaccion(@RequestBody List<Long> sucursalEntidadIdLst,
			@PathVariable String transaccion, Authentication authentication) {
		SegUsuarioEntity usuario = this.segUsuarioService.findByLogin(authentication.getName());
		Map<String, Object> response = new HashMap<>();
		try {
	...
	public ResponseEntity<?> getSucursalEntidadById(@PathVariable Long sucursalEntidadId,
		...
		Map<String, Object> response = new HashMap<>();
		try {
			SucursalEntidadAdmDto sucursalEntidadAdmDto = iSucursalEntidadService
					.getSucursalEntidadById(sucursalEntidadId);
	...
	public ResponseEntity<?> getListSucursalesEntidades(@PathVariable Long entidadId, Authentication authentication) {
		SegUsuarioEntity usuario = this.segUsuarioService.findByLogin(authentication.getName());
		Map<String, Object> response = new HashMap<>();
		try {
			List<SucursalEntidadAdmDto> sucursalEntidadAdmDtos = iSucursalEntidadService
					.getLisSucursalEntidadesByEntidadId(entidadId);
			if (!sucursalEntidadAdmDtos.isEmpty()) {
				response.put("status", true);
				response.put("message", "El listado fue encontrado.");
				response.put("result", sucursalEntidadAdmDtos);
	...
	public ResponseEntity<?> findSucursalesByEntidadId(Authentication authentication) {
	...
	try {
		 ...
		 if(entidad==null) {
			 System.out.println("------------------------- entidad es null");
		 }else {
			 System.out.println("------------------------- entidad no es null"+ entidad.getEntidadId());
		 }
		 
			List<SucursalEntidadEntity> sucursalEntidadAdmDtos = iSucursalEntidadService
					.findSucursalByEntidadId(entidad.getEntidadId());
			if (!sucursalEntidadAdmDtos.isEmpty()) {
				response.put("status", true);
				response.put("message", "El listado fue encontrado.");
				response.put("data", sucursalEntidadAdmDtos);
				return new ResponseEntity<>(response, HttpStatus.OK);
			} else {
				response.put("status", false);
				response.put("message", "El listado no fue encontrado.");
